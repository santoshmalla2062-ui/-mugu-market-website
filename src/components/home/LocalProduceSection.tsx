        ...
        <div className="flex flex-col lg:flex-row lg:items-end justify-between mb-12 gap-6">
          ...
          <div className="flex flex-wrap items-center gap-3">
            <div className="px-4 py-2 rounded-2xl bg-white/5 border border-white/10 text-xs text-emerald-300 flex items-center gap-2 font-mono">
              ...
              प्रत्यक्ष सम्पर्क उपलब्ध • Verified Sellers
            </div>
          </div>
        </div>
            ...
            >
              ...
              <div>
                ...
                <div className="mb-4">
                  ...
                  <p className="text-xs text-gray-400 font-mono mt-0.5">{item.nameEnglish}</p>
                  <div className="flex items-center gap-1 text-[11px] text-gray-400 mt-2">
                    <MapPin className="w-3 h-3 text-emerald-400 shrink-0" />
                    <span>मुख्य क्षेत्र: <strong className="text-gray-200">{item.mainOrigin}</strong></span>
                  </div>
                </div>
                ...
                <div className="bg-black/40 border border-white/5 rounded-2xl p-4 mb-4 space-y-3">
                  ...
                  <div className="flex items-center justify-between border-b border-white/5 pb-2.5">
                    ...
                    <div className="text-right">
                      <span className="text-xs text-gray-300 block">{item.unit}</span>
                  ...
                  <div className="grid grid-cols-2 gap-2 text-left pt-1">
                    <div>
                      <span className="text-[10px] text-gray-400 block">उत्पादन संकलन:</span>
                    ...
                    <div>
                      <span className="text-[10px] text-gray-400 block">डेलिभरी गन्तव्य:</span>
                      <span className="text-xs font-bold text-emerald-300 flex items-center gap-1 mt-0.5 truncate">
                        ...
                        {item.consumptionHub.split(',')[0]} र मुख्य सहर
                      </span>
                    </div>
                  </div>
                </div>

                {/* Direct Verified Sellers Section (सामान बिक्री गर्नेहरूको प्रत्यक्ष सम्पर्क) */}
                {showSellerContacts && item.featuredSellers && item.featuredSellers.length > 0 ? (
                  <div className="border-t border-white/10 pt-3.5 mb-4">
                    <div className="flex items-center justify-between mb-2">
                      <span className="text-[11px] font-bold text-emerald-400 uppercase tracking-wider flex items-center gap-1">
                        <Store className="w-3 h-3" /> मुख्य बिक्रेता तथा सम्पर्क:
                      </span>
                      <span className="text-[10px] text-gray-400">सिधै कुरा गर्नुहोस्</span>
                    </div>
                        ...
                        return (
                          ...
                          >
                            ...
                            <div className="flex items-center gap-1.5 shrink-0">
                              ...
                              <button
                                type="button"
                                onClick={() => handleSellerWhatsApp(seller, item.nameNepali)}
                                title="ह्वाट्सएपमा कुरा गर्नुहोस्"
                  ...
                  <div className="border-t border-white/10 pt-3 pb-2 text-center text-xs text-gray-400">
                    <p className="flex items-center justify-center gap-1.5 text-emerald-400 font-medium">
                      ...
                      सोधपुछका लागि हाम्रो मुख्य हटलाइनमा सम्पर्क गर्नुहोस्:
                    </p>
              ...
              >
                <span>थोक अर्डर वा अन्य बिक्रेता खोज्नुहोस्</span>
        ...
        <div className="mt-14 bg-gradient-to-r from-emerald-950/40 via-blue-950/30 to-emerald-950/40 border border-emerald-500/25 rounded-3xl p-6 sm:p-8 flex flex-col lg:flex-row items-center justify-between gap-6 text-center lg:text-left">
          <div className="max-w-2xl">
            <div className="inline-flex items-center gap-2 text-xs font-bold text-emerald-400 uppercase tracking-widest mb-1">
              <TrendingUp className="w-4 h-4" /> मुगु, हुम्ला र जुम्लाका कृषक, सहकारी तथा संकलकहरूका लागि
            </div>
            <h4 className="text-xl sm:text-2xl font-bold text-white">
              के तपाईं मुगु, हुम्ला वा जुम्लाको उत्पादन काठमाडौँ तथा अन्य सहरमा पठाउन चाहनुहुन्छ?
            </h4>
            <p className="text-xs sm:text-sm text-gray-300 mt-2 leading-relaxed">
              आफ्नो उत्पादन, परिमाण र सम्पर्क नम्बर यहाँ दर्ता गर्नुहोस्। हामी तपाईंको उत्पादनलाई देशका मुख्य बजार, होलसेल व्यापारी र ग्राहकहरूसँग सिधै जोडिदिनेछौँ।
            </p>
          </div>
          ...
          >
            आफ्नो उत्पादन दर्ता गर्नुहोस् (Register Store)
          </a>
        </div>
